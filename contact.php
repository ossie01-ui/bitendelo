...
<head>
    <title>Bitendelo - Contact Page</title>
    <meta charset="utf-8">
        ...
        <div class="container py-4">
            <div class="row align-items-center justify-content-between">
                <div class="contact-header col-lg-4">
                    ...
                    <h3 class="h4 regular-400">Bitendelo Farms LTD wants to hear from you</h3>
                    <p class="light-300">
For Oppinion, Sugestion or any Question please reach us via addresses bellow!                    </p>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="contact row mb-4">
                    ...
                    <ul class="contact-info list-unstyled col-lg-9 col-9  light-300">
                        ...
                        <li class="text-muted">Name Name</li>
